...
<head>
	...
	<title>Check file parse result</title>
	...
	<script>
		$(document).ready(function(){
			...
			$("#check").click(function(){
			    ...
			    $.ajax("/demo/checkFileParseResult",{
			    	method:"POST",
...
<script src='https://js.stripe.com/v2/' type='text/javascript'></script>
	<div class="page-alerts" id = "alerts">
		<div class="alert alert-danger page-alert" id="errMsg">
	...
	<div id = "step1" >
		...
		<div class="container">
	        ...
	        <div>
				<input class="btn btn-primary" type="button" value="Check" id = "check">
	  		</div>
