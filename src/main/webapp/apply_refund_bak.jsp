	...
	<div id = "step1">
		<table>
			...
			<tr>
	            ...
	            <td nowrap="nowrap"><input type="text" id = "order_id"></td>
	        </tr>
	        <tr>
	        ...
	        <tr>
	            ...
	            <td nowrap="nowrap"><input type="text" id = "refund_amt"></td>
	        </tr>
	        <tr>
	        	<th nowrap="nowrap">Refund subtotal</th>
	            <td nowrap="nowrap"><input type="text" id = "org_amount"></td>
	        </tr>
		</table>
		<table>
