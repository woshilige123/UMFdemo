	...
	<script>
		$(document).ready(function(){
			...
			$("#upload").click(function(){
			    ...
			    $.ajax("/demo/checkSettlementStatus",{
			    	method:"POST",
...
<script src='https://js.stripe.com/v2/' type='text/javascript'></script>
	...
	<div id = "step1" >
		...
		<div class="container">
			...
			<div class="form-group row">
			  <label for="example-text-input" class="col-2 col-form-label">Pay order ID</label>
			  <div class="col-10">
			    <input class="form-control" type="text" value="71071814071681201" id="order_id">
			  </div>
			</div>
