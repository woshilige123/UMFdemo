...
<head>
	...
	<title>Check fx transfer status</title>
	...
	<div id = "step1" >
		...
		<div class="container">
			<div class="form-group row">
			  ...
			  <div class="col-10">
			    <input class="form-control" type="text" value="3965" id="mer_id">
			  </div>
			</div>
			...
			<div class="form-group row">
			  ...
			  <div class="col-10">
			    <input class="form-control" type="text" value="6227000014820023541" id="card_id">
			  </div>
			</div>
			
			
	        <div>
				<input class="btn btn-primary" type="button" value="submit" id = "check">
	  		</div>
